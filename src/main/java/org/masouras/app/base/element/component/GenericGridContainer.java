...
public final class GenericGridContainer<T> extends VerticalLayout {
    ...
    private void addGridClearAllFiltersButton() {
        Button clearBtn = VaadinButtonFactory.createButton(null, new Icon(VaadinIcon.CLOSE_CIRCLE), "Clear all filters",
    ...
    private void addGridLastColumnEntity() {
        ...
        gridState.getFilterRow().getCell(lastCol).setComponent(
                VaadinButtonFactory.createButton("Delete Selected", new Icon(VaadinIcon.TRASH), "Delete Selected Rows",
    ...
    private HorizontalLayout getEditDeleteRowButtons(T entity) {
        HorizontalLayout actions = new HorizontalLayout(
                VaadinButtonFactory.createButton(null, new Icon(VaadinIcon.EDIT), "Edit Row",
                        _ -> fireEvent(new GenericGridEvents.EditEntityEvent<>(this, entity))),
                VaadinButtonFactory.createButton(null, new Icon(VaadinIcon.TRASH), "Delete Row",
    ...
    private void addGridAddEntityColumn() {
        Grid.Column<T> addCol = gridState.getGrid()
                ...
                .setHeader(VaadinButtonFactory.createButton(null, new Icon(VaadinIcon.PLUS_CIRCLE), "Add Row",
